...
export function StudentLoginShell({
  ...
  return (
    <div
      className={`relative flex h-auto max-h-none min-h-[100dvh] w-full max-w-full flex-col overflow-x-hidden overflow-y-visible bg-[#f8f7f0] text-slate-900 [box-sizing:border-box] dark:bg-[#0b1122] dark:text-white lg:h-[100dvh] lg:max-h-[100dvh] lg:min-h-[100dvh] lg:flex-row lg:overflow-hidden lg:bg-[#060f22] lg:dark:bg-[#060f22] ${dir === 'rtl' ? 'rtl' : 'ltr'}`}
    ...
    >
      ...
      <main
        className="relative z-10 box-border flex min-h-[100dvh] w-full max-w-full min-w-0 flex-1 flex-col items-stretch justify-start overflow-x-hidden overflow-y-visible bg-[#f8f7f0] px-5 py-8 sm:px-6 sm:py-10 lg:min-h-[100dvh] lg:h-[100dvh] lg:max-h-[100dvh] lg:w-auto lg:items-center lg:justify-start lg:overflow-y-auto lg:overflow-x-hidden lg:px-8 lg:py-10 xl:px-10 dark:bg-[#0b1122] lg:[overscroll-behavior:contain] lg:[scrollbar-gutter:stable]"
        style={{ boxSizing: 'border-box' }}
      >
